...
To distinguish between the many gestures, we have utilised a 5-bit binary numbered list-based approach which is generally used, facilitating the implementation of multiple gestures simultaneously. Through real-time gesture recognition, specific users can manipulate a computer using hand gestures in front of a camera linked to the system. This approach enables system control via hand gestures, reducing reliance on keyboard and mouse controls to some extent.
